...
namespace Reserva_B.Migrations
{
    ...
    [Migration("20211025040020_PersonasDireccionTelefono")]
    partial class PersonasDireccionTelefono
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Reserva_B.Models.Telefono", b =>
                {
                    ...
                    b.Property<int?>("ClientesDireccionTelefonosId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClientesDireccionTelefonosId");
            ...
            modelBuilder.Entity("Reserva_B.ViewModels.ClientesDireccionTelefonos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ClientesDireccionTelefonos");
                });
            ...
            modelBuilder.Entity("Reserva_B.Models.Telefono", b =>
                {
                    b.HasOne("Reserva_B.ViewModels.ClientesDireccionTelefonos", null)
                        .WithMany("Telefonos")
                        .HasForeignKey("ClientesDireccionTelefonosId");
            ...
            modelBuilder.Entity("Reserva_B.ViewModels.ClientesDireccionTelefonos", b =>
                {
                    b.HasOne("Reserva_B.Models.Direccion", "Direccion")
                        .WithMany()
